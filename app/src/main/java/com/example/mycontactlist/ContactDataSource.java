...
public class ContactDataSource {
    ...
    public boolean insertContact(Contact c) {
        ...
        try {
            ...
            initialValues.put("bestFriend",c.getBestFriendForever());
    ...
    public boolean updateContact(Contact c) {
        ...
        try {
            ...
            updateValues.put("bestFriend",c.getBestFriendForever());
            if(c.getPicture() != null) {
                ByteArrayOutputStream baos = new ByteArrayOutputStream();
                c.getPicture().compress(Bitmap.CompressFormat.PNG, 100, baos);
                byte[] photo = baos.toByteArray();
        ...
        try {
            ...
            while (!cursor.isAfterLast()) {
                ...
                if(cursor.getBlob(11) != null) {
                    byte[] byteArray = cursor.getBlob(11);
                    Bitmap bm = BitmapFactory.decodeByteArray(byteArray, 0 ,byteArray.length);
                    newContact.setPicture(bm);
